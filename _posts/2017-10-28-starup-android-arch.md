...
无关的通用架构，简单，但是可以提高创业公司的软件质量和生产力。
...
&emsp;&emsp;比方说，帐号注册/登录系统可以在很多APP都是第一个要考虑的事情，特别能考研开发人员的功力，
经验不够的开发人员评估，会觉得很简单，评估出来的工作量一般偏低，架构出来的东西会偏简单实现，
...
依赖，降低耦合。App的架构设计的时候，也尽量设计成子系统的形式，各个子系统职能尽量分明，输入输出清晰，这样子
迭代架构的时候，容易做到无痛替换。
...
* [ButterKnife](http://jakewharton.github.io/butterknife/),不要写很多findViewById了，IDE支持一键生成代码。点击变量还可以很快地定位
到xml，用得太普遍了。
